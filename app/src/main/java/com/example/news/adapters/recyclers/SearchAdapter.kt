...
class SearchAdapter : RecyclerView.Adapter<SearchAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val iVLogo = itemView.imageView_search_item_favorite
        ...
        fun bind(item:Article) {
            articles.let {
                ...
                Glide.with(itemView.context).load(url).centerCrop().placeholder(R.drawable.not_image).into(iVLogo)
